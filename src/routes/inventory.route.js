...
import {createInventory, updateInventory, allInventory,deleteById, inventoryById} from "../controllers/inventory.controller.js"
...
router.route("/inventory/:id").get(auth,adminAuth, inventoryById)
